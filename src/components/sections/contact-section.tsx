      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={ref}
          className={cn(
            ...
            inView ? "animate-fadeIn animate-slideInUp" : "opacity-0 translate-y-10"
          )}
        >
            ...
            <Card className="bg-card shadow-xl">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center">
                  ...
                  <a href="mailto:hello@nocturne.com" className="text-lg hover:text-accent transition-colors">pulsarx.inc@gmail.com</a>
                </div>
                <div className="flex items-center">
                  <Phone className="h-6 w-6 text-accent mr-3" />
                  <a href="tel:+1234567890" className="text-lg hover:text-accent transition-colors">+92 304 705858-5</a>
                </div>
                <div className="flex items-start">
                  <MapPin className="h-6 w-6 text-accent mr-3 mt-1" />
                  <p className="text-lg">Street 55 I8/3 Islamabad , Pakistan, WEB 40404</p>
                </div>
              </CardContent>
            </Card>
            <Card className="bg-card shadow-xl">
